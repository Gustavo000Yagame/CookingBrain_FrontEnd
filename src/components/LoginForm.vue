...
<template>
  <div class="login-container">
    <form class="form" @submit="handleSubmit">
      ...
      <div class="inputForm">
        ...
        >
          <g data-name="Layer 3" id="Layer_3">
            <path
              d="m30.853 13.87a15 15 0 0 0 -29.729 4.082 15.1 15.1 0 0 0 12.876 12.918 15.6 15.6 0 0 0 2.016.13 14.85 14.85 0 0 0 7.715-2.145 1 1 0 1 0 -1.031-1.711 13.007 13.007 0 1 1 5.458-6.529 2.149 2.149 0 0 1 -4.158-.759v-10.856a1 1"
            />
          </g>
        </svg>
        <input
      ...
      :disabled="isLoading
      <div class="flex-row">
        <button type="button" class="btn google" @click="$emit('google-login')">
